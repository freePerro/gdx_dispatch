"""
Scheduling router — calendar views, availability slots and conflicts. This is
a read-heavy view layer built on top of the existing Appointment model
(gdx_dispatch/routers/appointments.py).
